...
export const renderDeliveries = async (containerId) => {
    ...
    <div class="card delivery-card">
      ...
      <div class="delivery-actions">
        <button class="btn btn-primary btn-sm" data-update-delivery="${delivery.id}" data-status="picked_up">
          Mark as Picked Up
        </button>
        <button class="btn btn-success btn-sm" data-update-delivery="${delivery.id}" data-status="delivered">
          Mark as Delivered
        </button>
      </div>
    </div>
